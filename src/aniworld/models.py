...
from aniworld.config import DEFAULT_REQUEST_TIMEOUT, RANDOM_USER_AGENT, AVAILABLE_SITES
...
class Episode:
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        #print("wie oft wird das hier aufgerufen?")
    ...
    def _get_provider_from_html(self) -> dict:
        ...
        if not episode_links:
            print(
                f"{self.link} Episode nicht verfügbar."
            )
            return providers
        for link in episode_links:
            ...
            if provider_name and redirect_link and lang_key:
                ...
                url = "/".join(self.slug.split("/")[:3])
                providers[provider_name][lang_key] = f"{url}{redirect_link}"
    ...
    def auto_fill_details(self) -> None:
        ...
        #print ("auto_fill_details" , self.slug)
